...
class CustomHeaderMiddleware(MiddlewareMixin):
    ...
    def process_request(self, request):
        ...
        # Check if the coming request has a token
        ...
        if raw_token is not None:
            try:
                ...
                #### TODO: check the token validity in our system
                ...
                request.META['TOKEN_UPDATED'] = True
                ...
                #     print('token is valid for our system')
                #     ################################################################
                ...
                #         raise er
                # except:
                #     print('token is not exsited in our system')
...
class CustomAssingCookieMiddleware:
    ...
    def __call__(self, request):
        ...
        updated = self.getRequestHeaders('HTTP_TOKEN_UPDATED', request)
        if updated:
